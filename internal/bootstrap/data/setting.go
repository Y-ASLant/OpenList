...
func InitialSettings() []model.SettingItem {
	...
	siteVersion := fmt.Sprintf("%s - Frontend: %s - Build at: %s", conf.Version, conf.WebVersion, conf.BuiltAt)
	initialSettingItems := []model.SettingItem{
		...
		{Key: conf.SiteTitle, Value: "ASLantCloud", Type: conf.TypeString, Group: model.SITE},
		{Key: conf.Announcement, Value: "Hello.", Type: conf.TypeText, Group: model.SITE},
		...
		// style settings
		{Key: conf.Logo, Value: "https://aslant.top/favicon.ico", MigrationValue: "https://cdn.oplist.org/gh/OpenListTeam/Logo@main/logo.svg", Type: conf.TypeText, Group: model.STYLE},
		{Key: conf.Favicon, Value: "https://aslant.top/favicon.ico", MigrationValue: "https://cdn.oplist.org/gh/OpenListTeam/Logo@main/logo.svg", Type: conf.TypeString, Group: model.STYLE},
		...
		{Key: "share_icon", Value: "🗂️", Type: conf.TypeString, Group: model.STYLE},
		{Key: "home_container", Value: "hope_container", Type: conf.TypeSelect, Options: "max_980px,hope_container", Group: model.STYLE},
		{Key: "settings_layout", Value: "responsive", Type: conf.TypeSelect, Options: "list,responsive", Group: model.STYLE},
	...
	"epub": {
		...
		//}`, Type: conf.TypeText, Group: model.PREVIEW},
		{Key: "audio_cover", Value: "https://aslant.top/favicon.ico", MigrationValue: "https://cdn.oplist.org/gh/OpenListTeam/Logo@main/logo.svg", Type: conf.TypeString, Group: model.PREVIEW},
